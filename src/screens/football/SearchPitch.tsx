...
const SearchPitch: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{}}>
          <View style={{marginHorizontal:27,flexDirection:'row',flexWrap:'wrap',padding:10,justifyContent:'flex-start'}}>
              <TouchableOpacity onPress={()=>{setText(HA)}} style={{backgroundColor:"#e5e5e5", borderWidth:0.4,borderColor:"gray" ,borderRadius:20,marginHorizontal:5,marginVertical:5}}>
                <Text style={{padding:5}}>{HA}</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{setText(VH)}} style={{backgroundColor:"#e5e5e5", borderWidth:0.4,borderColor:"gray" ,borderRadius:20,marginHorizontal:5,marginVertical:5}}>
                <Text style={{padding:5}}>{VH}</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{setText(GS)}} style={{backgroundColor:"#e5e5e5", borderWidth:0.4,borderColor:"gray" ,borderRadius:20,marginHorizontal:5,marginVertical:5}}>
                <Text style={{padding:5}}>{GS}</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{setText(TL)}} style={{backgroundColor:"#e5e5e5", borderWidth:0.4,borderColor:"gray" ,borderRadius:20,marginHorizontal:5,marginVertical:5}}>
                <Text style={{padding:5}}>{TL}</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{setText(MD2)}} style={{backgroundColor:"#e5e5e5", borderWidth:0.4,borderColor:"gray" ,borderRadius:20,marginHorizontal:5,marginVertical:5}}>
