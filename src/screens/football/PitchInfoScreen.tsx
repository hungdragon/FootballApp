...
import { ApplicationState, onChangeName } from "src/redux";
import * as Animatable from "react-native-animatable";
import { useNavigation } from "@react-navigation/native";
import { setCodeNamePitch, setNamePitch } from "./Booking-Football/FootballSlice";
import axios from "axios";
import { BASE_URL } from "src/utils";
import LoadingApp from "src/components/LoadingApp";
import { setLocation } from "./cable/cableSlice";
...
const PitchInfoScreen: React.FC<Props> = ({navigation,route}:any) => {
