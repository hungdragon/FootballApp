...
import {
  ...
  setReviveData,
} from "../Booking-Football/FootballSlice";
...
const AddProductService: React.FC<Props> = ({ navigation }) => {
  const dispatch = useDispatch();
  const productServiceDATA = useAppSelector(
    (state) => state.footbalState.productServiceData
  );
  ...
  const RenderImage = (
    ...
    if (codeService === "coca") {
      ...
      return (
        ...
        >
          <Image source={Images.coca} style={{ width: 80, height: 80 }} />
        </TouchableOpacity>
      );
    }
    if (codeService === "revive") {
      return (
        ...
        >
          <Image source={Images.revive} style={{ width: 80, height: 80 }} />
        </TouchableOpacity>
      );
    }
    if (codeService === "7up") {
      return (
        ...
        >
          <Image source={Images.bayup} style={{ width: 80, height: 80 }} />
        </TouchableOpacity>
      );
    }
    if (codeService === "mar") {
      return (
        ...
        >
          <Image source={Images.marlboro} style={{ width: 80, height: 80 }} />
        </TouchableOpacity>
      );
    }
  };
