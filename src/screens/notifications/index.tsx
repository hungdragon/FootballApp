  ...
  //  console.log('vvv--',customerDetailData);
    ...
    return(
      ...
      <View style={{borderRadius:0}} >
        ...
        anchor={
            <View >
                <Text style={{backgroundColor:'red',fontSize:11,position:'absolute',zIndex:11,right:-7,top:-7,borderRadius:50,padding:1,paddingHorizontal:6,textAlign:'center'}}>1</Text>
       ...
       <TouchableOpacity
          ...
          style={styles.btnPopupEdit}>
            ...
            <AntDesign name="check" size={20} style={[styles.iconEdit, { color: 'green' }]} />
          <Text>{'Bạn vừa đặt thành công sân bóng !'}<Text style={{fontSize:11,textDecorationStyle:'dashed',color:'blue'}}> Xem ngay</Text></Text>
            </View>
          <Text style={{textAlign: 'right',fontSize:11,marginHorizontal:10,color:'grey'}}>{'20/12/2022 15:30'}</Text>
        </TouchableOpacity>
        <Divider />
        <TouchableOpacity
          onPress={() => {
